...
<div style="padding: 24px;">
    ...
    <div style="margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <a href="<?php echo e(route('projects.create')); ?>" style="padding: 10px 20px; background: #2563eb; color: white; text-decoration: none; border-radius: 8px; font-weight: 600; display: flex; align-items: center; gap: 8px;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #e5e7eb;">
                    <td style="padding: 12px 16px;">
                        <a href="<?php echo e(route('projects.show', $project)); ?>" style="color: #2563eb; text-decoration: none; font-weight: 500;">
                            <?php echo e($project->name); ?>

                        </a>
                    </td>
                    <td style="padding: 12px 16px; color: #6b7280;">
                        <?php echo e(Str::limit($project->description, 50) ?? 'No description'); ?>
                    ...
                    <td style="padding: 12px 16px;">
                        <span style="padding: 4px 8px; background: #dbeafe; color: #1e40af; border-radius: 4px; font-size: 0.875rem;">
                            <?php echo e($project->modules->count()); ?>

                        </span>
                    </td>
                    <td style="padding: 12px 16px; color: #6b7280;">
                        <?php echo e($project->creator->name ?? 'Unknown'); ?>

                    </td>
                    <td style="padding: 12px 16px; text-align: right;">
                        <div style="display: flex; gap: 8px; justify-content: flex-end;">
                            <a href="<?php echo e(route('projects.show', $project)); ?>" style="padding: 6px 12px; background: #2563eb; color: white; text-decoration: none; border-radius: 6px; font-size: 0.875rem;">
                                <i class="fas fa-eye"></i> View
                            </a>
                            <a href="<?php echo e(route('projects.edit', $project)); ?>" style="padding: 6px 12px; background: #f59e0b; color: white; text-decoration: none; border-radius: 6px; font-size: 0.875rem;">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this project?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\business automation ltd\sadi vai\Testpilot\app\Modules/Cypress/resources/views/projects/index.blade.php ENDPATH**/ ?>