        ...
        <div class="w-full">
            <div class="bg-white rounded-2xl shadow-xl p-8 md:p-10 animate-slide-in">
                ...
                <div class="lg:hidden text-center mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800"><?php echo e(config('app.name')); ?></h2>
                </div>
                ...
                <?php if($errors->any()): ?>
                    <div class="mb-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl">
                        <div class="flex items-center">
                            ...
                            <span><?php echo e($errors->first('error') ?: $errors->first()); ?></span>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="space-y-5">
                        <?php if(in_array('email', $authConfig['enabled_methods'])): ?>
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter your email" class="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all text-base">
                                </div>
                            </div>
                ...
                <?php if(isset($authConfig['enabled_methods']['social']) && count($authConfig['enabled_methods']['social']) > 0): ?>
                    <div class="mt-6">
                        <div class="relative">
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-4">
                            <?php if(in_array('google', $authConfig['enabled_methods']['social'])): ?>
                                <a href="<?php echo e(route('social.redirect', 'google')); ?>" class="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all font-medium text-gray-700">
                            ...
                            <?php if(in_array('facebook', $authConfig['enabled_methods']['social'])): ?>
                                <a href="<?php echo e(route('social.redirect', 'facebook')); ?>" class="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all font-medium text-gray-700">
                ...
                <?php if($authConfig['registration_allowed']): ?>
                    <div class="mt-8 text-center">
                        <p class="text-gray-600">
                            Don't have an account? 
                            <a href="<?php echo e(route('register')); ?>" class="font-semibold text-cyan-600 hover:text-cyan-700">Sign Up</a>
                        </p>
                    </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('User::layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Arpa\business automation ltd\sadi vai\Testpilot\app\Modules/User/resources/views/auth/login.blade.php ENDPATH**/ ?>